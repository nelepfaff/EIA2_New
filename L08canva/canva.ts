...
function createGradient(crc2: CanvasRenderingContext2D, width: number, height: number): CanvasGradient {
...
function drawRandomShapes(crc2: CanvasRenderingContext2D, width: number, height: number): void {
...
function drawPattern(crc2: CanvasRenderingContext2D, width: number, height: number): void {
